...
export default function FeaturesSection() {
    return (
        <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Features" text2="Everything you need to run great ads" text3="From idea to publish-ready copy — Snappify handles the hard part so you don't have to." />
            ...
            <div className="mt-40 relative mx-auto max-w-5xl">
                ...
                >
                    Snappify uses advanced AI to understand your product, audience, and goals — then crafts short, punchy ad copy that actually converts. No agency. No waiting. Just results.
                </motion.p>
                <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
                    ...
                    >
                        <img className="h-full w-auto" src="/assets/features-showcase-1.png" alt="Snappify ad generator dashboard" width={1000} height={500} />
                    </motion.div>
                    ...
                    >
                        <img src="/assets/features-showcase-2.png" alt="Snappify output preview" width={1000} height={500} className="hover:-translate-y-0.5 transition duration-300" />
                        <h3 className="text-[24px]/7.5 text-slate-300 font-medium mt-6">More clicks, less effort — ads that work from day one</h3>
                        <p className="text-slate-300 mt-2">Snappify helps marketers, founders, and creators launch better ads faster — without hiring a copywriter.</p>
                        <a href="#" className="group flex items-center gap-2 mt-4 text-pink-600 hover:text-pink-700 transition">
                            See how Snappify works
